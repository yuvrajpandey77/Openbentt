	...
	theme: {
		...
		extend: {
			...
			fontFamily: {
				...
				openbentt: ['Inter', '"Noto Sans"', 'system-ui', '-apple-system', 'BlinkMacSystemFont', '"Segoe UI"', 'sans-serif'],
				display: ['Inter', '"Noto Sans"', 'system-ui', '-apple-system', 'BlinkMacSystemFont', '"Segoe UI"', 'sans-serif'],
