...
export function MarketingMission() {
  return (
    <section id="mission" className="marketing-section marketing-section-band scroll-mt-32 border-y border-border/40">
      <div className="marketing-container">
        <MarketingReveal className="mx-auto max-w-3xl text-center">
          <p className="marketing-eyebrow">{mission.eyebrow}</p>
          <h2 className="marketing-section-title mt-3">{mission.title}</h2>
